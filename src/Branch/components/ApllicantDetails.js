                          ...
                          <>
                            {i.name === "Business Details" && (
                              <input
                                ...
                                defaultValue={
                                  data?.business_id[el.db_name] || "N/A"
                                }
                              />
                            )}
                              ...
                              data?.businessShareData.length > 0 ? (
                                data?.businessShareData.map((o, idx) => (
                                  <>
                                    <input
                                      disabled={disabled}
                                      className="rounded-lg p-4 border mx-3 w-1/3 mx-2 n9"
                                      name={el.db_name}
                                      onChange={onfieldChanges}
                                      defaultValue={o[el.db_name] || "N/A"}
                                    />
                                ...
                                <input
                                  disabled={disabled}
                                  className="rounded-lg p-4 border mx-3 w-1/3 mx-2 n10"
                                  name={el.db_name}
                                  onChange={onfieldChanges}
                                  defaultValue={"N/A"}
                                />
                              ...
                              data?.loanReferenceData.length > 0 ? (
                                data?.loanReferenceData.map((o, idx) => (
                                  <>
                                    <input
                                      disabled={disabled}
                                      className="rounded-lg p-4 border mx-3 w-1/3 mx-2 n11"
                                      name={el.db_name}
                                      onChange={onfieldChanges}
                                      defaultValue={o[el.db_name] || "N/A"}
                                    />
                                ...
                                <input
                                  disabled={disabled}
                                  className="rounded-lg p-4 border mx-3 w-1/3 mx-2 n12"
                                  name={el.db_name}
                                  onChange={onfieldChanges}
                                  defaultValue={"N/A"}
                                />
                          ...
                          <>
                            {i.name === "Shareholder Details" &&
                              data?.businessShareData.map((o, idx) => (
                                <select
                                  disabled={disabled}
                                  className="rounded-lg p-4 border mx-3 w-1/3 mx-2"
                                  name={el.db_name}
                                  onChange={onfieldChanges}
                                >
                                  {el.options &&
                                ...
                                (l) =>
                                  l === k && (
                                    <section className="flex space-evenly items-center">
                                      ...
                                      <input
                                        className="rounded-lg p-4 border mx-4"
                                        disabled={disabled}
                                        name={k}
                                        onChange={onfieldChanges}
