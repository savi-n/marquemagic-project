const flow = [
  {
    name: "Bussiness Verification",
    id: "bussiness-verification",
    fields: {},
  },
  {
  ...
  {
    name: "Partner/Director Details",
    id: "partner-director-details",
    fields: {
  ...
  },
  {
    ...
    id: "bussiness-address-details",
    fields: {
      "bussiness-address-details": {
  ...
  {
    name: "Loan Details",
    id: "bussiness-loan-details",
    fields: {
      "bussiness-loan-details": {
        label: "Loan Details",
        data: [
          {
            name: "NC Reference Number",
            placeholder: "NC reference number",
            rules: {
              required: true,
            },
            type: "text",
