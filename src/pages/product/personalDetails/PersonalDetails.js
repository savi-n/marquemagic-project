...
export default function PersonalDetailsPage({ id, map, onFlowChange, fieldConfig }) {
	const {
		state: { whiteLabelId }
	...
	return (
		<Div>
			...
			/>
			<SalaryDetails jsonData={map.fields['salary-details'].data} register={register} formState={formState} />
			<ButtonWrap>
