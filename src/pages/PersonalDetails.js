...
export default function PersonalDetails(props) {
	return (
		<Layout>
			<PersonalDetailsComponent pageName={props.pageName} jsonData={jsonData.personal_details} />
			<SalaryDetails pageName={props.pageName} jsonData={jsonData.salary_details} />
			<Footer />
		</Layout>
	);
}
