export const initialFormState = {
	annual_op_expense: '1',
	annual_revenue: '1',
	business_email: 'shryeas.ra@namastecredit.com',
...
export const BUSINESS_MOBILE_NUMBER_FIELD_NAME = 'business_mobile_no';
