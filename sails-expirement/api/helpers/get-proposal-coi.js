module.exports = {
  ...
  exits: {
    ...
    success: {
      outputFriendlyName: 'Proposal coi',
    },
  ...
  fn: async function (inputs, exits) {
    ...
    switch (insMasterMap.get(insuranceRec?.ins_id)?.ins_name) {
      case 'PNB Metlife':
        data = await sails.helpers.pnbMetLifeProposalCoi(propRefNum, insAppRef, insuranceRec.loan_id);
        break;
      case 'HDFC Life Insurance':
        data = await sails.helpers.hdfcLifeProposalCoi(propRefNum, insAppRef);
        break;
    }
